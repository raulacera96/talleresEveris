...
public class ClienteServiceImp implements ClienteService {
    ...
    public List<Cliente> findByFirstName(String nombreCliente) { return clienteRepository.findByFirstName(nombreCliente); }

    public List<Cliente> findByLastName(String apellidoCliente) { return clienteRepository.findByLastName(apellidoCliente); }

    public List<Cliente> findByFirstNameAndLastName(String nombre, String apellido) { return clienteRepository.findByFirstNameAndFirstName(nombre, apellido); }
}
